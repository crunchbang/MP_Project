...
\author{Akanksha~Dwivedi,~\IEEEmembership{MT2016006,}
        Anoop~Toffy,~\IEEEmembership{MT2016016,,}
        Athul~Suresh,~\IEEEmembership{MT2016030,}
        and~Tarini~Chandrashekhar,~\IEEEmembership{MT2016144}}% <-this % stops a space
...
The project aims to provide a comprehensive set of assistance features to aid
the driver (or autonomous vehicle) to drive safely. This includes a number of
indicators about the environment, the major cue being detection of potholes
in the road ahead.
...
\begin{IEEEbiographynophoto}{Anoop Toffy}
Biography text here.
...
\begin{IEEEbiographynophoto}{Athul Suresh}
Biography text here.
\end{IEEEbiographynophoto}

\begin{IEEEbiographynophoto}{Tarini Chandrashekhar}
Biography text here.
\end{IEEEbiographynophoto}
